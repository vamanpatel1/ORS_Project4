...
public class UserCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		System.out.println(" Uctl BaseBean populateBean");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("Uctl doGet 1111111");
		String op = DataUtility.getString(request.getParameter("operation"));
		// get model
		UserModel model = new UserModel();
		long id = DataUtility.getLong(request.getParameter("id"));
		System.out.println("Uctl doGet : " + op);
		if (id > 0 || op != null) {
			System.out.println("in id > 0  condition");
			UserBean bean;
			try {
				bean = model.findByPK(id);
				System.out.println("Vaman11111111111");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("Uctl doPost");
		...
		System.out.println(">>>><<<<>><<><<><<><>**********" + id + ", op : " + op);

		UserModel model = new UserModel();
		if (OP_SAVE.equalsIgnoreCase(op) || OP_UPDATE.equalsIgnoreCase(op)) {
			UserBean bean = (UserBean) populateBean(request);
			System.out.println("Uctl DoPost 11111111");
			...
			try {
				if (id > 0) {
					...
					model.update(bean);
					ServletUtility.setBean(bean, request);
					System.out.println(" Uctl doPost 222222");
					ServletUtility.setSuccessMessage("User is successfully Updated", request);

				} else {
					System.out.println(" Uctl doPost 33333");
				...
				System.out.println(" Uctl doPost 4444444");
				ServletUtility.setBean(bean, request);
				ServletUtility.setErrorMessage("Login id already exists", request);
			}
		} else if (OP_DELETE.equalsIgnoreCase(op)) {
			System.out.println(" Uctl doPost 5555555");

			UserBean bean = (UserBean) populateBean(request);
			try {
				model.delete(bean);
				System.out.println("Uctl doPost  6666666");
			...
			System.out.println("Uctl doPost 77777");
