...
public class LoginCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (OP_SIGN_UP.equals(op) || OP_LOG_OUT.equals(op)) {
			System.out.println("loginCtl V1");
			return pass;
		}

		String login = request.getParameter("login");
		System.out.println("loginCtl V2");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("loginCtl Do Get");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("loginCtl Do Post");
		String op = DataUtility.getString(request.getParameter("operation"));
		...
		if (OP_SIGN_IN.equalsIgnoreCase(op)) {
			System.out.println(" loginCtl Do post 2222");
			...
			try {
				...
				if (bean != null) {
					...
					System.out.println(" loginCtl Do post 33");
			...
			System.out.println("loginCtl Do post 55");

			ServletUtility.redirect(ORSView.USER_REGISTRATION_CTL, request, response);
			return;

		}
		System.out.println("loginCtl forward view");
		ServletUtility.forward(getView(), request, response);
