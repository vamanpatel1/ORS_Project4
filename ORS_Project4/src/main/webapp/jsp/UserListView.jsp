			...
			<table width="100%" align="center">
				<tr>
					...
					<td align="center">
						...
						type="text" name="loginid" placeholder="Enter Login-Id"
                        ...
                        type="text" name="dob" id="udate" placeholder="Enter DOB"
                        ...
                        type="text" name="mobileNo" placeholder="Enter Mobile No"
                        maxlength="10" value="<%=ServletUtility.getParameter("mobileNo", request)%>">
                        &emsp;  
